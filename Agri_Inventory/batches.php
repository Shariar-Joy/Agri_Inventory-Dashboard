...
if (!isset($_SESSION['selectedWarehouse'])) {
...
$warehouse = $warehouseStmt->get_result()->fetch_assoc();
$warehouseStmt->close();
...
<main>
    ...
    <div class="data-table">
        <div class="table-header">
            <h2>All Batches in <?php echo $warehouse['City']; ?> Warehouse</h2>
